...
var challenges = [
    ...
    ,{options: {floorCount: 5, elevatorCount: 5, spawnRate: 10, elevatorCapacities: [30]}, condition: requireDemo()}
    ,{options: {floorCount: 2, elevatorCount: 5, spawnRate: 20, elevatorCapacities: [20]}, condition: requireDemo()}
];
